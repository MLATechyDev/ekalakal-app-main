...
class AdminResidentList extends StatefulWidget {
  const AdminResidentList({super.key});

  @override
  State<AdminResidentList> createState() => _AdminResidentListState();
}

class _AdminResidentListState extends State<AdminResidentList> {
